...
def game_loop():
    ...
    while running:
        ...
        # Анимация изображения при закрытии окна
        if pygame.time.get_ticks() - exit_time < 3000:  # 3 секунды
            # Двигаем изображение вправо
            exit_rect.x += 10  # Скорость движения из-за края
